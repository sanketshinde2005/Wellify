                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div
                          className={`p-4 border rounded-lg flex items-center gap-3 cursor-pointer ${
                            newAppointment.type === 'in-person' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200'
                          }`}
                          onClick={() => setNewAppointment({...newAppointment, type: 'in-person'})}
                        >
                          <div className={`p-2 rounded-full ${
                            newAppointment.type === 'in-person' ? 'bg-indigo-100' : 'bg-gray-100'
                          }`}>
                            <User className={`h-5 w-5 ${
                              newAppointment.type === 'in-person' ? 'text-indigo-600' : 'text-gray-500'
                            }`} />
                          </div>
                          <div>
                            <div className={`font-medium ${
                              newAppointment.type === 'in-person' ? 'text-indigo-600' : 'text-gray-700'
                            }`}>In-person</div>
                        ...
                        <div
                          className={`p-4 border rounded-lg flex items-center gap-3 cursor-pointer ${
                            newAppointment.type === 'video' ? 'border-indigo-500 bg-indigo-50' : 'border-gray-200'
                          }`}
                          onClick={() => setNewAppointment({...newAppointment, type: 'video'})}
                        >
                          <div className={`p-2 rounded-full ${
                            newAppointment.type === 'video' ? 'bg-indigo-100' : 'bg-gray-100'
                          }`}>
                            <svg className={`h-5 w-5 ${
                              newAppointment.type === 'video' ? 'text-indigo-600' : 'text-gray-500'
                          ...
                          <div>
                            <div className={`font-medium ${
                              newAppointment.type === 'video' ? 'text-indigo-600' : 'text-gray-700'
                            }`}>Telehealth</div>
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                        {['09:00', '10:00', '11:00', '13:00', '14:00', '15:00', '16:00', '17:00'].map((slot) => (
                          <div
                            key={slot}
                            className={`py-2 px-3 text-center border rounded-md cursor-pointer text-sm ${
                              newAppointment.time === `${slot}` ? 'bg-indigo-100 border-indigo-500 text-indigo-700' : 'hover:bg-gray-50'
                            }`}
