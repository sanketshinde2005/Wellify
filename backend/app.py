...
def index():
    return jsonify({
        ...
        "endpoints": {
            "/api/predict": "POST - Predict disease based on symptoms",
            "/api/symptoms": "GET - Get list of available symptoms",
            "/api/diseases": "GET - Get list of possible diseases"
        }
    })
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            response = {
                ...
                'description': dis_des,
                'precautions': precautions[0].tolist() if hasattr(precautions[0], 'tolist') else precautions[0],
                'medications': [med for med in medications if med],
                'diet': [d for d in rec_diet if d],  
...
# API endpoint to get all possible diseases
